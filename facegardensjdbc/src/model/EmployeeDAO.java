...
public class EmployeeDAO {
    ...
    //SELECT an Employee
    //*******************************
    public static Employee searchEmployee (String empId) throws Exception {
        ...
        try {
            ...
            ResultSet rsEmp = util.DBUtil.dbExecuteQuery(selectStmt);
    ...
    public static ObservableList<Employee> searchEmployees () throws Exception {
        ...
        try {
            //Get ResultSet from dbExecuteQuery method
            ResultSet rsEmps = util.DBUtil.dbExecuteQuery(selectStmt);
    ...
    //*************************************
    public static void updateEmpEmail (String empId, String empEmail) throws Exception {
        ...
        try {
            util.DBUtil.dbExecuteUpdate(updateStmt);
        } catch (SQLException e) {
    ...
    //DELETE an employee
    //*************************************
    public static void deleteEmpWithId (String empId) throws Exception {
    ...
    //INSERT an employee
    //*************************************
    public static void insertEmp (String name, String lastname, String email) throws Exception {
        //Declare a DELETE statement
        String updateStmt =
                "BEGIN\n" +
